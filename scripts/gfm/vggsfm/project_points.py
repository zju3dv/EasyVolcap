...
def main(args):
    ...
    idx = torch.randperm(xyz.shape[-2])[:xyz.shape[-2] // downsample_factor].to(xyz.device)
    export_pts(
        xyz[idx],
        rgb[idx],
...
if __name__ == "__main__":
    ...
    # Scene parameters
    parser.add_argument('--data_root', type=str, default='data/datasets/GameSynthetic/wukong/wukong_xietao_250116/250116_012703_254')
    parser.add_argument('--easy_root', type=str, default='check_dir/verify/vggsfm')
    parser.add_argument('--proj_root', type=str, default='check_dir/verify/vggsfm/project_points')
    parser.add_argument('--output', type=str, default='project_points.json')
